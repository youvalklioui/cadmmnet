...
def train_model(model, dataset_train_path, num_layers=30, epochs=30, lr=1e-4, kernel_scale=0.5, 
                kernel_length=7, batch_size=2048, num_training_samples=100000, model_path=None, 
                load_latest_state=False, device='cuda'):
